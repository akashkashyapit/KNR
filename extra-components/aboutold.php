...
<head>
	...
	<title>Glojivoc - Multipurpose Business Consulting and Professional Services HTML5 Bootstrap4 Responsive Template
	</title>
	<!-- HEADER -->
	<?php
			...
			<div class="row">
				<div class="col-md-6 col-lg-8">
					...
					<div class="text-content">
						<p>
							Deliver Value added, technically superior and cost optimum solutions to enhance the safety &
							reliability of Electrical systems by combining knowledge, experience and technology.</p>
					</div>
					<hr class="divider">
					<div class="text-content">
						<h3>Who we are?</h3>
						<p>KNR is amongst the leading engineering and consultancy service providers in India, having
							expertise in providing solutions up to 765Kv Air Insulated and Gas Insulated substations,
							Transmission lines, Wind & Solar power evacuation projects. Our area of expertise covers
							Detailed Design and Engineering including electrical and civil for substations, transmission
							lines, solar and wind farms. We also carry out specialised studies like Insulation
							coordination studies including VFTO analysis, Integrated analysis of GIS, dynamic stability
							studies, Power system studies, residual life assessment, technical due diligence of
							transmission assets and more.
						</p>
						<p>Established in 2003 with a dedicated team of experts and engineering professionals we have
							grown in size and strength. With a dedicated team of experts in High Voltage engineering
							comprising PHD scholars and post graduates, we deliver techno economically superior and
							practically implementable solutions. We have successfully completed many prestigious &
							challenging projects up to 765 KV transmission systems as well as industrial power systems.
						</p>
						<p>We are a part of the JEF Group established in 1994 and together as a group we offer total solutions in Low Voltage and High Voltage Engineering.</p>
					</div>
				...
				<div class="col-md-6 col-lg-4">
					<div class="dark-bg our-vision light-color padding-40">
						...
						<p>
							To achieve a consistent growth rate of over 40% by augmenting our basket of services and
